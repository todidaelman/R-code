...
```{r plotting of hourly density plots of all scenarios}
...
# saveRDS(raster_list_full, "rotation_output_analysis/delta_Tmrt_data/raster_list_full.Rdata")
...
```{r loading in the overview dataframes}
