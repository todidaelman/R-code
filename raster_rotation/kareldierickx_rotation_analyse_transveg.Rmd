...
for (rotation_folder in folder_list){
  ...
  figure_output_folder <- file.path("figures", "rotation3", folder_name)
...
debuggen: waarom verspringen de uren wanneer het scenario transveg toenoemt
```{r}



sum_df1 <- raster_list_to_delta_df(raster_list_full, "simulation_transveg_30", 2)
sum_df2 <- raster_list_to_delta_df(raster_list_full, "simulation_transveg_35", 2)

sum_df1
sum_df2

animation_of_rasters(raster_list_full$simulation_transveg_20, "r165_tv30")
