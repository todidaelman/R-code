animation_of_rasters <- function(individual_raster_list, animationname = "animation"){
  ...
  saveGIF(
    ...
    interval = 0.5, movie.name = paste0(animationname, ".gif"))
}
